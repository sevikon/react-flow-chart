...
exports.PortCustom = function (props) { return (React.createElement(PortDefaultOuter, { style: { backgroundColor: props.port.type === 'left' ? advanced_1.COLOR_INPUT : advanced_1.COLOR_OUTPUT } },
