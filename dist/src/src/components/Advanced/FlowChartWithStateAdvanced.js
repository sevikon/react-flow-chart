...
var actions = require("../../container/actions");
var mapValues_1 = require("../../container/utils/mapValues");
var LinkCustom_1 = require("./components/LinkCustom");
var NodeCustom_1 = require("./components/NodeCustom");
var NodeInnerCustom_1 = require("./components/NodeInnerCustom");
var PortCustom_1 = require("./components/PortCustom");
/**
...
var FlowChartWithStateAdvanced = /** @class */ (function (_super) {
    ...
    FlowChartWithStateAdvanced.prototype.render = function () {
        ...
        return (React.createElement(index_1.FlowChart, { chart: this.state, callbacks: callbacks, Components: __assign({}, Components, { Node: NodeCustom_1.NodeCustom, Port: PortCustom_1.PortCustom, NodeInner: function (_a) {
                    var node = _a.node;
                    return NodeInnerCustom_1.NodeInnerDefaultWrapper({
                        node: node,
                        props: {
                ...
                }, Link: function (props) { return LinkCustom_1.LinkCustomWrapper(props, {
